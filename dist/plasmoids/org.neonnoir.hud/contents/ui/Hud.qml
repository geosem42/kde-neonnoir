...
Item {
    ...
    function ramp(v) {
        return v > 0.85 ? "#F346EB" : v > 0.60 ? "#E1A536" : "#36D7D7";
    }
    ...
    RowLayout {
            ...
            Repeater {
                ...
                Item {
                    ...
                    Text {
                        ...
                        color: parent.here ? "#36D7D7" : "#4B5056"
                        font.family: "JetBrains Mono"
                        font.pixelSize: 10
            ...
            Repeater {
                ...
                Item {
                    ...
                    Rectangle {
                        anchors { left: parent.left; right: parent.right; bottom: parent.bottom }
                        height: 2
                        color: model.IsDemandingAttention ? "#F346EB" : "#36D7D7"
        ...
        Row {
            ...
            Nick { height: meters.height; stroke: "#067878" }
            ...
            Nick { height: meters.height; stroke: "#067878"; visible: tmpCell.visible }
            ...
            Row {
                ...
                Value {
                    ...
                    color: tmp.value > 85 ? "#F346EB" : tmp.value > 70 ? "#E1A536" : "#D9DFE5"
                }
            }
            ...
            Nick { height: meters.height; stroke: "#067878"; visible: dskCell.visible }
            ...
            Nick { height: meters.height; stroke: "#067878"; visible: uptCell.visible }
        ...
        Nick { Layout.fillHeight: true; stroke: "#067878" }
