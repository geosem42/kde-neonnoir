        ...
        ColumnLayout {
            ...
            Axis {
                ...
                variants: [
                    ...
                    { id: "riced", label: "Riced", ready: true }
                ]
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    radius: 5
                    border.width: 1
                    border.color: selected ? "#36D7D7" : "#293037"
                    color: selected ? "#0D2B2B"
                                    : (hover.hovered && ready ? "#3A434E" : "#0D131A")
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            ...
                            color: !cell.ready ? "#4B5056"
                                               : (cell.selected ? "#36D7D7" : "#A1A9B0")
                            font.family: "IBM Plex Sans"
                            font.pixelSize: 11
                        }
