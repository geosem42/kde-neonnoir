...
Item {
    ...
    readonly property color cVoid:    "@VOID@"
    readonly property color cCard:    "@CARD@"
    readonly property color cView:    "@VIEW@"
    readonly property color cRaised:  "@RAISED@"
    readonly property color cHair:    "@HAIR@"
    readonly property color cFloat:   "@FLOAT@"
    readonly property color cHover:   "@HOVER@"
    readonly property color cText:    "@TEXT@"
    readonly property color cDim:     "@DIM@"
    readonly property color cCyan:    "@CYAN@"
    readonly property color cCyanHi:  "@CYANHI@"
    readonly property color cMagenta: "@MAGENTA@"
    readonly property color cInk:     "@INK@"
    readonly property color cNeg:     "@NEG@"
    readonly property color cNeutral: "@NEUTRAL@"
